<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_meating');?>
            </div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_meeting/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo get_phrase('link');?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                                class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('manage_meeting');?></button>
                    </div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('manage_meating');?>
            </div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    <table id="example23" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('Meeting Type');?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('Link');?></div>
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $link['meeting_type'];?></td>
                                <td><?php echo $link['link'];?></td>
                                                            
                                <td>

                                    <a href="#"
                                        onclick="confirm_modal('<?php echo base_url();?>admin/manage_meeting/delete/<?php echo $link['meeting_code'];?>');"><button
