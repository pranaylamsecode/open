    ...
    <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('Assign Role For:');?>  <?php echo $selected_admin['name'];?></div>
        ...
        <?php echo form_open(base_url() . 'admin/updateAdminRole/'. $param2, array('class' => 'form-horizontal form-goups-bordered validate'));?>
            ...
            <table class="display nowrap" cellspacing="0" width="100%">
                ...
                <tr>
                    <td><input class="check" name="manage_meeting" value="1" <?php if($this->db->get_where('admin_role', array('admin_id' => $param2))->row()->manage_meeting) echo 'checked';?> type="checkbox"></td>
                    <td><input class="check" name="manage_quiz" value="1" <?php if($this->db->get_where('admin_role', array('admin_id' => $param2))->row()->manage_quiz) echo 'checked';?> type="checkbox"></td>
                </tr>
            </table>
            <hr>
