                ...
                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    if(count($details)) {
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url(); ?>examquiz/edit_exam_quiz_question/<?php echo $quiz_obj['id']; ?>"
                                    class="btn btn-info btn-circle btn-xs" style="color:white">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="#"
                                    onclick="confirm_modal('<?php echo base_url();?>examquiz/manage_exam_quiz_question/delete/<?php echo $quiz_obj['id']; ?>');"><button
