<?php $students = $this->db->get_where('exam_quiz_details', array('exam_quiz_id' => $quiz_id))->result_array();
                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="row panel-body">
                        <div class="col-sm-12">
                            ...
                            <?php echo form_open(base_url() . 'examquiz/add_exam_quiz/update/' .$quiz_id , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
