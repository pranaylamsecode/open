        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i
                            class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW ASSIGNMENT HERE<i
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="date" name="timestamp" value="2018-08-19" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-sm btn-rounded"> <i
                                class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_assignment');?></button>
                    </div>
                    <br>
                    <?php echo form_close();?>
            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                ...
                foreach($assignment as $key => $assignment):?>
                            <tr>
                                ...
                                <td><?php echo $this->db->get_where('subject', array('subject_id' => $assignment['subject_id']))->row()->name;?>
                                </td>
                                <td><?php echo $this->db->get_where('teacher', array('teacher_id' => $assignment['teacher_id']))->row()->name;?>
                                </td>
                                <td><?php echo $assignment['description'];?></td>
                                <td>
                                    <a href="<?php echo base_url().'uploads/assignment/'. $assignment['file_name'];?>"><button
                                            type="button" class="btn btn-info btn-circle btn-xs"><i
                                                class="fa fa-download"></i></button></a>
                                    <a
                                        onclick="showAjaxModal('<?php echo base_url();?>modal/popup/assignment_edit/<?php echo $assignment['assignment_id'];?>');"><button
                                            type="button" class="btn btn-success btn-circle btn-xs"><i
                                                class="fa fa-pencil"></i></button></a>
                                    <a
                                        href="<?php echo base_url();?>assignment/assignment/delete/<?php echo $assignment['assignment_id'];?>"><button
